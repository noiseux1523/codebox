...
%
    ...
    fcount=fcount+icf; % ICF = 1, car on a caculÃ© une fois la fonction et que le cout est de 1 compte par run de f.
...
% ICI ON CALCULE N POINTS A MOINS QUE IL Y EN AIT DES IRRÃ‰ALISABLES
